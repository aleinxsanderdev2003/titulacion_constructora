...
<nav class="navbar navbar-expand-lg navbar-light" style="  background: transparent;">
    ...
    .hero_slider_nav {
        ...
        width: 40px; /* Ajusta el ancho del botón según tu preferencia */
        height: 40px; /* Ajusta la altura del botón según tu preferencia */
        display: flex;
        align-items: center;
...
<style>
        ...
        .hero_slide_background {
            ...
            animation: zoomAnimation 10s infinite alternate; /* Animación de zoom infinita */
        }
        ...
        @keyframes zoomAnimation {
            ...
            100% {
                transform: scale(1.1); /* Aplicar zoom */
            }
        }
    </style>
    ...
    <div class="super_container">
        ...
        <style>
            ...
            .left-text p {
                color: #000000fff; /* Cambia el color del texto */
            }
            ...
            .right-image {
                ...
                min-height: 400px; /* Ajusta la altura de la imagen */
            }
